...
@section('content')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="kode_rak" id="kode_rak"
                        ...
                        value="{{ old('kode_rak', $product->kode_rak) }}">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="periode_return" id="periode_return"
                        class="w-full rounded-lg border-gray-300 py-3 px-4 focus:border-blue-500 focus:ring-blue-500 shadow-sm transition-colors"
                        value="{{ old('periode_return', $product->periode_return) }}" placeholder="e.g. 30">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="stock_min" id="stock_min"
                        class="w-full rounded-lg border-gray-300 py-3 px-4 focus:border-blue-500 focus:ring-blue-500 shadow-sm transition-colors"
                        value="{{ old('stock_min', $product->stock_min) }}" required>
                </div>
            </div>
            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
                <div class="flex justify-between items-center mb-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Edit larger units like Pack, Box, or Lusin that multiply the base
                            stock.</p>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const existingUnits = @json(old('units', $product->units));
            ...
            function addUnitRow(unit = null) {
                ...
                row.innerHTML = `
                    <div class="col-span-12 md:col-span-2">
                        ...
                        <input type="text" name="units[${unitIndex}][unit_name]" value="${unit ? (unit.unit_name || '') : ''}" placeholder="e.g. Box" class="w-full rounded-md border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500" required>
                    </div>
                    <div class="col-span-12 md:col-span-2">
                        <label class="block text-xs font-medium text-gray-700 mb-1">Qty (Multiplier)</label>
                        <input type="number" name="units[${unitIndex}][quantity]" value="${unit ? (unit.quantity || '') : ''}" placeholder="e.g. 12" class="w-full rounded-md border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500" required>
                    </div>
                    <div class="col-span-12 md:col-span-3">
                        <label class="block text-xs font-medium text-gray-700 mb-1">Barcode</label>
                        <input type="text" name="units[${unitIndex}][barcode]" value="${unit ? (unit.barcode || '') : ''}" placeholder="Optional" class="w-full rounded-md border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
                    <div class="col-span-12 md:col-span-2">
                        <label class="block text-xs font-medium text-gray-700 mb-1">Selling Price</label>
                        <input type="number" name="units[${unitIndex}][price]" value="${unit ? (unit.price || '') : ''}" placeholder="e.g. 50000" class="w-full rounded-md border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500" required>
                    </div>
                    <div class="col-span-12 md:col-span-2">
                        <label class="block text-xs font-medium text-gray-700 mb-1">Member Price</label>
                        <input type="number" name="units[${unitIndex}][member_price]" value="${unit ? (unit.member_price || '') : ''}" placeholder="Optional" class="w-full rounded-md border-gray-300 text-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
            ...
            addBtn.addEventListener('click', () => addUnitRow(null));
