...
@section('content')
    <div class="max-w-5xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Record New Purchase</h1>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <form action="{{ route('pembelian.store') }}" method="POST" x-data='purchaseForm(@json($products))'>
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <input type="date" name="tgl_beli" value="{{ date('Y-m-d') }}"
                        ...
                        <template x-for="(item, index) in items" :key="index">
                            <div
                                ...
                                <div class="flex-1 w-full md:w-auto">
                                    ...
                                    <select :name="`details[${index}][product_id]`" class="w-full select2-alpine"
                                        ...
                                        setTimeout(() => {
                                            ...
                                            $($el).on('change', function(e) {
                                                ...
                                                item.product_unit_id = ''; // reset unit on product change
...
@section('scripts')
    <script>
        function purchaseForm(productsData = []) {
            return {
